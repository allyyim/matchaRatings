                      ...
                      <div className="card-body py-2">
                        ...
                        <div className="entry-metrics">
                          <div className="entry-stat-cluster mb-2">
                            ...
                            <span className="greenness-inline" title="Matcha Greenness"><span className="greenness-inline-value">{entry.greenness.toFixed(0)}%</span><span className="greenness-inline-caption">matcha greenness</span></span>
                          </div>
