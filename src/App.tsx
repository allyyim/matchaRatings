...
function App() {
  ...
  useDemoCleanup(isDemoAccount, API_BASE_URL)
                    ...
                    <article key={`place-rating-${entry.id}-${index}`} className="card border-0 shadow-sm">
                      <div className="card-body py-2">
                        ...
                        <div className="entry-metrics">
                          ...
                          <div style={{ color: '#6c757d', marginBottom: '0.5rem', fontWeight: 'normal' }}>Matcha Greenness Score: {entry.greenness.toFixed(0)}%</div>
                      ...
                      <div className="card-body py-2">
                        ...
                        <div className="entry-metrics">
                          <div className="entry-stat-cluster mb-2">
                            ...
                            <span className="greenness-inline" title="Matcha Greenness Score"><span className="greenness-inline-value">{entry.greenness.toFixed(0)}%</span><span className="greenness-inline-caption">matcha greenness score</span></span>
                          </div>
      ...
      {activePage === 'explore' && (
        <Suspense
          fallback={
            <main id="main-content" className="container py-3 py-md-5 px-3 px-md-4" tabIndex={-1}>
              <div className="d-flex justify-content-center py-5">
                <div className="spinner-border text-success" role="status" aria-label="Loading Explore">
                  <span className="visually-hidden">Loading…</span>
                </div>
              </div>
            </main>
        ...
        >
          <ExplorePage
            exploreActiveTab={exploreActiveTab}
            setExploreActiveTab={setExploreActiveTab}
            explorePlaces={explorePlaces}
            exploreUsers={exploreUsers}
            currentUserName={currentUserName}
            followingSet={followingSet}
            setFollowingSet={setFollowingSet}
            setSavedEntryToast={setSavedEntryToast}
            openExplorePlaceRatings={openExplorePlaceRatings}
